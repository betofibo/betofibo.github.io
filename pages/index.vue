              ...
              <div class="landing-header-box">
                <div class="landing-header-box__content">
                  <nuxt-link to="/blog/posts/5f53289ebb5d9e00179a945e" style="text-decoration: none;">
                    <h1 class="text-white" v-bind:class="[{'subheader': $vuetify.breakpoint.xsOnly}, {'header': !$vuetify.breakpoint.mobile}, {'display-2': $vuetify.breakpoint.xlOnly}]">Desarrollos agiles que te ayudará a estar un paso adelante de la competencia<v-icon large color="teal">mdi-arrow-right</v-icon></h1>
